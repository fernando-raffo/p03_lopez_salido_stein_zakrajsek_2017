...
category: "Sentiment, Gdp Growth, Baa, Figure 2, Extension"
---

# Chart: Figure 2: Credit-Market Sentiment and GDP Growth (1929-present, extended)
Extension of Figure II past the paper's 2015 sample end, through the most recent available data.

## Chart
```{raw} html
<iframe src="../../_static/P01/figure_2_extended.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: FRED, Office of Financial Research</p>
```
[Full Screen Chart](../download_chart/P01/figure_2_extended.html)




Same construction as the replication chart (Table II column (1) only), extended through the present, including the 2020 COVID shock and recovery.


## Chart Specs

| Chart Name             | Figure 2: Credit-Market Sentiment and GDP Growth (1929-present, extended)                                                   |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure_2_extended                                               |
| Tags                   | Sentiment, Gdp Growth, Baa, Figure 2, Extension                                      |
...
| HTML Chart             | [HTML](../download_chart/P01/figure_2_extended.html)    |
