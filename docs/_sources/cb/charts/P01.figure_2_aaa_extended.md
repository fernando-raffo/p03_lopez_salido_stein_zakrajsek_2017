...
# Chart: Figure 2 (Aaa variant): Credit-Market Sentiment and GDP Growth (1929-present, extended)
Aaa-spread extension of Figure II through the most recent available data.

## Chart
```{raw} html
<iframe src="../../_static/P01/figure_2_aaa_extended.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: FRED, Office of Financial Research</p>
```
[Full Screen Chart](../download_chart/P01/figure_2_aaa_extended.html)




Same construction as the Aaa replication chart (Table II column (1) only), extended through the present.


## Chart Specs

| Chart Name             | Figure 2 (Aaa variant): Credit-Market Sentiment and GDP Growth (1929-present, extended)                                                   |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure_2_aaa_extended                                               |
...
| HTML Chart             | [HTML](../download_chart/P01/figure_2_aaa_extended.html)    |
