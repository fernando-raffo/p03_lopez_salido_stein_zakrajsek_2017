...
category: "Credit Spread, Aaa, Figure 1, Extension"
---

# Chart: Figure 1 (Aaa variant): Aaa-Treasury Credit Spread (1925-2025, extended)
Aaa-spread extension of Figure I through the most recent available FRED data.

## Chart
```{raw} html
<iframe src="../../_static/P01/figure_1_aaa_extended.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: FRED, Office of Financial Research</p>
```
[Full Screen Chart](../download_chart/P01/figure_1_aaa_extended.html)




Same construction as the Aaa replication chart, extended through the present.


## Chart Specs

| Chart Name             | Figure 1 (Aaa variant): Aaa-Treasury Credit Spread (1925-2025, extended)                                                   |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure_1_aaa_extended                                               |
| Tags                   | Credit Spread, Aaa, Figure 1, Extension                                      |
...
| HTML Chart             | [HTML](../download_chart/P01/figure_1_aaa_extended.html)    |
