...
## Chart
```{raw} html
<iframe src="../../_static/P01/figure_1_aaa_replication.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: FRED, Office of Financial Research</p>
```
[Full Screen Chart](../download_chart/P01/figure_1_aaa_replication.html)
...
| Chart Name             | Figure 1 (Aaa variant): Aaa-Treasury Credit Spread (1925-2015)                                                   |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure_1_aaa_replication                                               |
...
| HTML Chart             | [HTML](../download_chart/P01/figure_1_aaa_replication.html)    |
